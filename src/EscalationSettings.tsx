...
export function EscalationSettings({ api }: { api: Api }) {
  ...
  return (
    <>
      <div className="pagetitle">Escalation chain</div>
      <p className="pagesub">Who gets alerted when a problem is raised, and how fast it climbs the chain. To choose which problems trigger and set deadlines per branch, use the Branch alerts tab.</p>
